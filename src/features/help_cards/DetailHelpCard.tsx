  ...
  <Box sx={{ width: '100%', bgcolor: 'background.paper' }}>
    ...
    <Box sx={{ mt: 5, p: 2, bgcolor: '#d8d8d8' }}>
      ...
      {user ? (
        ...
        <Box sx={{ display: 'flex' }}>
          <Box sx={{ flex: '1 0 50%', pr: '0.5rem' }}>
            <Typography variant="h6">Do you have an account?</Typography>
            <Login />
          </Box>
          <Box sx={{ flex: '1 0 50%', pl: '0.5rem' }}>
            <Typography variant="h6">No account? Register</Typography>
            <Register />
          </Box>
        </Box>
      )}
