    ...
    <Container maxWidth="md" sx={{ marginTop: '2rem', mb: 7 }}>
      ...
      <Typography variant="body1" component="div">
        <Typography>
          ...
          <Typography>Tel: +49 176 284 18180,</Typography>
          <Typography>web: www.ait-tr.de</Typography>
          <Typography>E-mail: go@ait-tr.de</Typography>
          <Typography>
          ...
          <Typography>St.Nr (TaxID) 30/203/51209</Typography>
          <Typography>USt-IdNr. (VAT ID) DE352204126</Typography>
        </Typography>
      </Typography>
    </Container>
  );
